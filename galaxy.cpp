        ...
        for (auto& bullet : bullets) {
            ...
            for (auto& moon : moons) {
                if (moon.CheckHit(bullet)) {
                    ...
                    bullet.active = false;
                    if (moon.IsDead() && BULLET_DAMAGE < 30) {
                        BULLET_DAMAGE += 1;
                    }
                    break;
                }
            ...
            for (auto& earth : earths) {
                if (earth.CheckHit(bullet)) {
                    ...
                    bullet.active = false;
                    if (earth.IsDead() && BULLET_DAMAGE + 2 <= 30) {
                        BULLET_DAMAGE += 2;
                    }
                    break;
                }
            ...
            for (auto& saturn : saturns) {
                if (saturn.CheckHit(bullet)) {
                    ...
                    bullet.active = false;
                    if (saturn.IsDead() && BULLET_DAMAGE + 3 <= 30) {
                        BULLET_DAMAGE+=3;
                    }
                    break;
                }
            ...
            for (auto& jupiter : jupiters) {
                if (jupiter.CheckHit(bullet)) {
                    ...
                    bullet.active = false;
                    if (jupiter.IsDead() && BULLET_DAMAGE + 4 <= 30) {
                        BULLET_DAMAGE+=4;
                    }
                    break;
                }
            ...
            for (auto& sun : suns) {
                if (sun.CheckHit(bullet)) {
                    ...
                    bullet.active = false;
                    if (sun.IsDead() && BULLET_DAMAGE + 5 <= 30) {
                        BULLET_DAMAGE+=5;
                    }
                }
            }
